// Função contendo o template para o envio do e-mail com o código de duplo fator para recuperar senha
function twoFactorTemplatePassword(codigo) {
  return `
          ...
          <tr>
            <td style="padding-top:24px;">
              ...
              <p style="margin-top:12px; color:#4b5563; line-height:1.6;">
                Use o código abaixo para seguir com a valição da sua identidade e posteriormente redefinir sua senha:
              </p>
...
module.exports = twoFactorTemplatePassword;
